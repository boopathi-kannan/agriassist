  ...
  return product &&  (
      <div className="mt-12">
              ...
              <div className="text-sm w-full md:w-1/2">
                  ...
                  <div className="flex items-center gap-0.5 mt-1">
                      {Array(5).fill('').map((_, i) => (
                            <img src={i<4 ?"":""} className="md:w-4 w-3.5"/>
                  ...
                  <ul className="list-disc ml-4 text-gray-500/70">
                      {product.descriptionh.map((desc, index) => (
          ...
          <div className="flex flex-col items-center mt-20">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 sm:grid-cols-3 gap-3 md:gap-6 lg:grid-cols-5 mt-6 w-full">
